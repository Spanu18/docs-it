...
- Segui il nostro account ufficiale su [Twitter](https://x.com/vuejs).
...
- [Chat Discord](https://discord.com/invite/vue): Un posto per gli sviluppatori Vue per incontrarsi e parlare in real time.
...
- [Community Twitter (non ufficiale)](https://x.com/i/communities/1516368750634840064): Una community su Twitter, dove puoi incontrare altri appassionati di Vue, ottenere tips o semplicemente parlare di Vue.
...
- [Made with Vue.js](https://madewithvuejs.com/): vetrina di progetti e librerie create con Vue.
- [Il Subforum "Show and Tell"](https://github.com/vuejs/core/discussions/categories/show-and-tell): Un altro posto dove vedere cosa altri hanno costruito con e per l'ecosistema di Vue.
...
- **Aiuta gli organizzatori dei meetup.** Non ci sarà mai troppo aiuto quando si tratta di organizzare un evento, quindi offri una mano per aiutare gli organizzatori locali a rendere ogni evento una bella esperienza.
  Se hai domande su come puoi partecipare maggiormente alla tua community Vue locale, contattaci su Twitter sul profilo [@vuejs_events](https://x.com/vuejs_events)!
